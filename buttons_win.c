...
int main()
{
	...
	printf("\t%c The Buttons Game %c\n", 186, 186);
	printf("\t%c    or MANCALA    %c\n", 186, 186);
	printf("\t%c   by Hildigerr   %c\n", 186, 186);
	printf("\t\t\b%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n",200,205,205,205,205,
...
void print_board(void)
{
	...
	/*Top Boarder*/
	if( board_width[0] == 2) printf("%c%c%c", 201, 205, 205);
		else printf("%c%c", 201, 205);
	for(x = 1; x < 7; x++)
	{
		if( board_width[x]== 2 ) printf("%c%c%c", 203, 205, 205);
			else printf("%c%c", 203, 205);
	}
	if( board_width[7] == 2 ) printf("%c%c%c%c\n", 203, 205, 205, 187);
		else printf("%c%c%c", 203, 205, 187);

	/*Top Trays*/
	for(x = 0; x < 7; x++)
	{
		if( board_top[x] > 9 ) printf("%c%d", 186, board_top[x]);
			else if( board_width[x] == 2 ) printf("c %d", 186, board_top[x]);
				else printf("%c%d", 186, board_top[x]);
	}
	if( board_width[7] == 2 ) printf("%c  %c\n", 186, 186);
		else printf("%c %c\n", 186, 186);

	/*Mid Boarder*/
	if( board_width[0] == 2 ) printf("%c  %c", 186, 204);
		else printf("%c %c", 186, 204);
	for(x = 1; x < 6; x++)
	{
		if( board_width[x]== 2 ) printf("%c%c%c", 205, 205, 206);
			else printf("%c%c", 205, 206);
	}
	if( board_width[6] == 2 ) printf("%c%c%c", 205, 205, 185);
		else printf("%c%c", 205, 185);
	if( board_width[7] == 2 ) printf("  %c\n", 186);
		else printf(" %c\n", 186);

	/*Btm Trays*/
	if( board_width[0] == 2 ) printf("%c  ", 186);
		else printf("%c ", 186);
	for(x = 1; x <= 7; x++)
	{
		if( board_btm[x] > 9 ) printf("%c%d", 186, board_btm[x]);
			else if( board_width[x] == 2 ) printf("%c %d", 186, board_btm[x]);
				else printf("%c%d", 186, board_btm[x]);
	}printf("%c\n", 186);

	/*Btm Boarder*/
	if( board_width[0] == 2 ) printf("%c%c%c", 200, 205, 205);
		else printf("%c%c", 200, 205);
	for(x = 1; x < 7; x++)
	{
		if( board_width[x]== 2 ) printf("%c%c%c", 202, 205, 205);
